        ...
        <footer class="footer fixed-bottom">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © <?= $time->getyear() ?>
              <a href="http://www.bootstrapdash.com/" target="_blank">TPS 02</a>. All rights reserved.</span>
            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">PEMILU 2019
            </span>
          </div>
        </footer>
        <!-- partial -->
